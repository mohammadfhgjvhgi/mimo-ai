...
export async function GET() {
  try {
    ...
    // P6-4: Observability Metrics — all queries parallelized for speed
    const [completedTasks, failedTasks, toolUsageAgg, agentUsageAgg, durationAgg] = await Promise.all([
